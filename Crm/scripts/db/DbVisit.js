...
dbTools.visitPlanogramListGet = function(visitId, skuCatId, datasetGet) {
    log("visitPlanogramListGet(" + visitId + ", " + skuCatId + ")");
    dbTools.db.transaction(function(tx) {
...
dbTools.visitPlanogramQuestionListGet = function(visitId, planogramId, datasetGet) {
    log("visitPlanogramQuestionListGet(" + planogramId + ")");
    dbTools.db.transaction(function(tx) {
